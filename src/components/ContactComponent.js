...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'Lastname Name should be >= 3 chars';
        ...
        return (
            <div className="container">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Contatct Us</BreadcrumbItem>
                </Breadcrumb>
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={{ size: 3, offset: 1 }}>
                                    <Input type="select" name="contactType" value={this.state.conactType}
                                        onChange={this.handleInputChange}>
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Input>
